  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead 
        pageType="page" 
        pageSlug="contact" 
        customTitle="Contact Azim's Tech - Get Expert System Administration Help"
        customDescription="Contact Fazla Rabby Azim for system administration, cloud computing, and DevOps consultation. Available for long-term projects and technical support."
      />
